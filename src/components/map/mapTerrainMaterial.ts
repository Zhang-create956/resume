...
import shenzhenTerrainHeightMapUrl from '../../assets/textures/map/shenzhen-terrain-height.png';
import { mapTheme } from './mapTheme';

export type MapTerrainHeightSource = 'stylized' | 'shenzhen-dem';
...
export type MapTerrainMaterialConfig = {
  ...
  heightSource?: MapTerrainHeightSource;
};
...
function configureShenzhenDemTexture(texture: THREE.Texture) {
...
export function getTerrainTextures() {
  if (!terrainTextures) {
    ...
    terrainTextures = {
      ...
      shenzhenDemMap: configureShenzhenDemTexture(loader.load(
        shenzhenTerrainHeightMapUrl,
        markTextureReady,
        undefined,
        markTextureReady,
      )),
...
export function createMapTerrainMaterial(
  ...
  const textures = getTerrainTextures();
  const displacementMap = config.heightSource === 'shenzhen-dem'
    ? textures.shenzhenDemMap
